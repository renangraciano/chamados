...
define('SECRET_SALT','toOxIgrCLrzUH1hwok0KmOigMr22oJAb');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','renan@webforged.net');

# Database Options
# ---------------------------------------------------
# Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','mysql.webforged.net');
define('DBNAME','webfo_tickets');
define('DBUSER','webfo_tickets');
define('DBPASS','t4QXXYFk0wf2k8CAZ52gqw==');
